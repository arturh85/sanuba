...
mod tests {
    ...
    fn test_creature_update_hunger() {
        ...
        // Update for 1 second
        // let died = creature.update(1.0, &sensory, &world);
    ...
    fn test_creature_action_planning() {
        ...
        // creature.update(0.1, &sensory, &world);
