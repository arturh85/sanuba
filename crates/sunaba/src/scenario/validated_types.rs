...
impl ValidatedMaterialId {
    pub const MAX: u16 = 42; // WIRE is currently the highest defined material (Powder Game materials)
...
mod tests {
    ...
    fn test_material_id_validation() {
        ...
        assert!(ValidatedMaterialId::new(42).is_ok()); // WIRE (max)
        assert!(ValidatedMaterialId::new(43).is_err()); // Out of range
