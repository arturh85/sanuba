...
// Re-export from sunaba-simulation for convenience
pub use sunaba_simulation::{CHUNK_AREA, CHUNK_SIZE, Pixel, pixel_flags};
...
impl Chunk {
    ...
    pub fn count_non_air(&self) -> usize {
        ...
        self.pixels
            .iter()
            .filter(|p| p.material_id != MaterialId::AIR)
            .count()
    }
